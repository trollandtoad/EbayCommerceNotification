...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.ebay.com/commerce/notification/v1';
    ...
    {
        $report  = 'PHP SDK (eBay\Commerce\Notification) Debug Report:' . PHP_EOL;
            ...
            [
                ...
                "variables" => [
                    "basePath" => [
                        ...
                        "default_value" => "/commerce/notification/v1",
                    ]
                ]
            ]
        ];
