...
/**
 * DestinationSearchResponse Class Doc Comment
 *
 * @category Class
...
class DestinationSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DestinationSearchResponse';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'limit' => 'int',
        'destinations' => '\eBay\Commerce\Notification\Model\Destination[]'
    ];
     ...
     * Sets limit
     *
     * @param int|null $limit The number of records to show in the current response. Default: 20
     *
     * @return self
     */
     ...
     * Gets destinations
     *
     * @return \eBay\Commerce\Notification\Model\Destination[]|null
     */
     ...
     * Sets destinations
     *
     * @param \eBay\Commerce\Notification\Model\Destination[]|null $destinations An array that contains the destination details.
     *
     * @return self
     */
