...
class Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'parameters' => '\eBay\Commerce\Notification\Model\ErrorParameter[]',
        'subdomain' => 'string'
    ];
     ...
     * Gets parameters
     *
     * @return \eBay\Commerce\Notification\Model\ErrorParameter[]|null
     */
     ...
     * Sets parameters
     *
     * @param \eBay\Commerce\Notification\Model\ErrorParameter[]|null $parameters An array of name/value pairs that describe details the error condition. These are useful when multiple errors are returned.
     *
     * @return self
     */
