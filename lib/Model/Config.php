...
class Config implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['alert_email'] = $data['alert_email'] ?? null;
    }
    ...
    {
        return $this->container['alert_email'];
    }

    /**
     * Sets alert_email
     *
     * @param string|null $alert_email The alert email address for this application.
     *
     * @return self
     */
    public function setAlertEmail($alert_email)
    {
        $this->container['alert_email'] = $alert_email;
