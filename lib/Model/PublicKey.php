...
class PublicKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets key
     *
     * @param string|null $key The public key that is returned for the specified key ID. This value is used to validate the eBay push notification message payload.
     *
     * @return self
     */
