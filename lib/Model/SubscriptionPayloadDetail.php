...
class SubscriptionPayloadDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $delivery_protocol The supported protocol. For exmaple: HTTPS For implementation help, refer to <a href='https://developer.ebay.com/api-docs/commerce/notification/types/api:ProtocolEnum'>eBay API documentation</a>
     *
     * @return self
     */
