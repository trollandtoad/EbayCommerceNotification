...
/**
 * DeliveryConfig Class Doc Comment
 *
 * @category Class
 ...
 */
class DeliveryConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryConfig';
     ...
     * Sets endpoint
     *
     * @param string|null $endpoint The endpoint for this destination.
     *
     * @return self
     */
     ...
     *
     * @param string|null $verification_token The verification token associated with this endpoint.
     *
     * @return self
     */
