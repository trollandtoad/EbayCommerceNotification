...
class ConfigApi
{
    ...
    public function getConfigWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Commerce\Notification\Model\Config' === '\SplFileObject') {
     ...
     *
     * @param  \eBay\Commerce\Notification\Model\Config $config The configurations for this application. (optional)
     *
     * @throws \eBay\Commerce\Notification\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
