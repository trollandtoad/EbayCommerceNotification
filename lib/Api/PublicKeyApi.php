...
class PublicKeyApi
{
     ...
     *
     * @param  string $public_key_id The unique key ID that is used to retrieve the public key. Note: This is retrieved from the X-EBAY-SIGNATURE header that is included with the push notification. (required)
     *
    ...
    {
        list($response) = $this->getPublicKeyWithHttpInfo($public_key_id);
        return $response;
    }
    ...
    public function getPublicKeyWithHttpInfo($public_key_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Commerce\Notification\Model\PublicKey' === '\SplFileObject') {
